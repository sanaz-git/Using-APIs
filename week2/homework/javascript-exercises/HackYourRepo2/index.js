  ...
  selectBox.addEventListener('input', (e) => {
    ...
    listData.forEach((element) => {
      if (element.name == e.target.value) {
        ...
        topic5.setAttribute(
          'style',
          'padding:10px; border:1px solid lightgray; text-align:center; font-size:20px; color:gray',
        );
  ...
  async function fetchContributions(url2) {
    try {
      ...
      data.forEach((element) => {
        ...
        img2.setAttribute(
          'style',
          ' padding-top:5px; width: 15%; height: 15%; border-radius:50%; margin-right:20px; margin-left:30px',
        );
        ...
        contName.setAttribute(
          'style',
          'min-width:30%; font-size:1vw; text-align:center; height:10%; margin-top:20px; margin-left:10%; border-style: groove; border-radius:10%',
        );
        ...
        contNum.setAttribute(
          'style',
          'min-width:10%; font-size:1vw; text-align:center; height:10%; margin-top:20px; margin-left:10%;  border-style: groove; border-radius:10%',
        );
...
async function fetchData(url) {
  try {
    ...
    err.setAttribute(
      'style',
      'background-color: #4a707a;width: 400px; height: 100px;padding: 15px;position: absolute;top: 50%;left: 50%;margin: -70px 0 0 -200px; color: white; font-family: "Space Mono", monospace; text-align: center ',
    );
